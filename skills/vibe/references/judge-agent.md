...
Part of Vibe Science v7.0 TRACE (originated as Pillar 2 extension in v5.0 IUDEX). A third agent meta-reviews R2's review quality, not the claims themselves. R3 answers the question: "Who reviews the reviewer?"
