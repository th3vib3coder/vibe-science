...
See `references/evidence-engine.md` for full schema. Quick template:
...
## Skills Required
- [Which specialist tools will be needed]
```
...
See `references/reviewer2-ensemble.md` for full mandatory output schema. File naming:
