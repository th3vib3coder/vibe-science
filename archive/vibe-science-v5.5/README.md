...
[![Gates](https://img.shields.io/badge/quality_gates-34-red.svg)](#quality-gates)
...
v5.5 is an **additive upgrade** born from the 12-mistake post-mortem of the CP+CRISPR research run. Every change traces to a concrete mistake that was NOT caught by v5.0's automated checks. No new subsystems — only targeted improvements to existing protocols.
...
| **3** | GATES BLOCK | Quality gates are hard stops, not suggestions | 34 gates block pipeline (8 schema-enforced) |
...
│
├── gates/
│   └── gates.md                    # All 34 gates with pass/fail criteria
│
├── assets/
...
| **5.5** | **ORO** | **2026** | **Post-mortem driven. 7 new gates (L-1, DQ1-DQ4, DD0, DC0). R2 INLINE mode. SSOT rule. Structured logbook. 34 total gates. Domain-general data quality enforcement.** |
...
graph TD
    ...
    V50 --> V55[v5.5<br>ORO]
    PM[Post-mortem<br>12 mistakes] --> V55
...
*Built with Claude. Tested against Reviewer 2. Survived 21 sprints. Post-mortem driven. Validated by 3 models.*
