...
|-----------|-------|----------|---------|-------------|----------|
| [dir 1] | "[method] AND [domain]" | PubMed | 0 | NO | PROCEED |
| [dir 2] | "[method2] AND [domain]" | PubMed | 3 | YES (Smith 2024) | DIFFERENTIATE: we add X |
| [dir 3] | "[method3] AND [domain]" | bioRxiv | 1 | YES (exact match) | PIVOT |
```
