...
The fault taxonomy is defined in `assets/fault-taxonomy.yaml`. Eight categories, derived from real errors observed in literature-based research:
...
| SFI-03 | Physical impossibility | Claim violating known domain constraints |
| SFI-04 | Noise-as-signal | Sub-threshold effect presented as meaningful |
| SFI-05 | Simulation-only claim | Simulation result presented without experimental validation |
...
| SFI-08 | Missing practical constraint | Comparison without considering system-level constraints |
