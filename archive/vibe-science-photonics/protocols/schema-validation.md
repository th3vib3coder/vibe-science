...
8 of 36 gates (the highest-stakes ones) require schema-valid artifacts, plus the serendipity-seed object. v5.5 adds 7 new gates (DQ1-DQ4, DC0, DD0, L-1) that are instruction-enforced, not schema-enforced.
