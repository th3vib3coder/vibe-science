...
| Task | Skill | Notes |
|------|-------|-------|
| Literature search | `openalex-database`, `web_search` | IEEE Xplore, Optica, SPIE, arXiv |
| AI-powered search | `perplexity-search` | For broad discovery queries |
| Systematic review | `literature-review` | Structured literature review workflow |
| Research lookup | `research-lookup` | Quick paper/concept lookup |
| Statistical analysis | `statsmodels` | Regression, GLM, meta-analysis |
| Visualization | `matplotlib`, `scientific-visualization` | BER curves, eye diagrams, comparison charts |
| Data organization | `polars`, `exploratory-data-analysis` | Structured comparison tables |
| ML (if applicable) | `scikit-learn` | For meta-analysis or trend extraction |
