# Vibe Science v5.0 Templates — Photonics Fork
...
```yaml
---
vibe_science_version: 5.0.0-photonics
rq: RQ-001
runtime: solo|team
...
tree_nodes_good: 0
tree_nodes_pruned: 0
gates_status: {G0: pending, G1: pending, G2: pending, G3: pending, G4: pending, G5: pending, B0: pending, HE0: pending, HE1: pending, HE2: pending, HE3: pending}
...
- **Confounders controlled:** [list: temperature, fiber_type, device_generation, measurement_setup, etc.]
- **Effect:** [coefficient / OR / difference]
- **Sign:** [positive | negative]
- **Magnitude:** [value]
- **p-value:** [value]
...
## EXPERT-ASSERTIONS.md Template

```markdown
# Expert Assertions

Domain expert knowledge captured during research sessions. These assertions have priority over model speculation (LAW 0).

## EA-001
- **Assertion:** [Domain expert's statement — exact phrasing]
- **Source:** Expert
- **Domain:** [photonics | VCSEL | IM-DD | optical-interconnect | fiber-optics | modulation]
- **Confidence floor:** 0.70
- **Context:** [What prompted this assertion — question, contradiction, correction]
- **Claims affected:** [C-xxx, C-yyy — claims that must be consistent with this assertion]
- **Contradicts:** [C-zzz — any existing claims that conflict with this assertion]
- **Status:** ACTIVE | SUPERSEDED | REFINED
- **Captured:** YYYY-MM-DD
```

---

## Contradiction Matrix Template

```markdown
# Contradiction Matrix

Cross-reference of expert assertions vs. literature claims. Updated when new assertions or claims are added.

| EA | Claim | Relationship | Resolution |
|----|-------|-------------|------------|
| EA-001 | C-005 | CONSISTENT | — |
| EA-002 | C-012 | CONTRADICTS | Expert override — C-012 downgraded, documented |
| EA-003 | C-018 | REFINES | C-018 updated with expert qualification |
```
